...
- `APP_OBJECT_STORAGE__PUBLIC_INCLUDE_BUCKET` (`true`/`false`)
- `APP_OBJECT_STORAGE__AUTO_CREATE_BUCKET` (`true`/`false`)
- `APP_OBJECT_STORAGE__SET_PUBLIC_READ_POLICY` (`true`/`false`)
